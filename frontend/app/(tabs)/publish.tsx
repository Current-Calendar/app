...
export default function PublishScreen() {
  ...
  const [calendarData] = useState<PublishData>({
  ...
  const handlePublish = async () => {
    setIsLoading(true);
    try {
      // TODO: Integrate with GraphQL mutation to create/publish calendar
      const publishPayload = {
        nombre: calendarData.nombre,
        descripcion: calendarData.descripcion,
        estado: selectedPrivacy,
        origen: selectedOrigin,
        // portada: calendarData.portada,
      };

      console.log("Publishing calendar:", publishPayload);

      // Simulate API call
      await new Promise((resolve) => setTimeout(resolve, 1500));

      Alert.alert("Success", "Calendar published successfully!", [
        {
          text: "OK",
          onPress: () => {
            // TODO: Navigate back or to calendar detail
        ...
        <View style={[styles.card, isDesktop && styles.cardDesktop]}>
          ...
          <View style={styles.previewSection}>
            ...
            <View style={styles.coverPreview}>
              ...
              <Text style={styles.coverPreviewText}>Cover Image</Text>
            </View>

            {/* Calendar Details Preview */}
            <View style={styles.detailsPreview}>
              <Text style={styles.previewTitle}>{calendarData.nombre}</Text>
              <Text 
                style={styles.previewDescription} 
                numberOfLines={2}
              >
                {calendarData.descripcion}
              </Text>
            ...
            {isDesktop && (
              ...
              >
                {isLoading ? (
                  ...
                  <Text style={styles.publishText}>Publish Calendar</Text>
                )}
              </Pressable>
            )}
          </View>
