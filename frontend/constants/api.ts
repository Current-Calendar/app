...
export const API_CONFIG = {
  ...
  endpoints: {
    ...
    searchUsers: (query: string) => buildEndpoint(`users?search=${encodeURIComponent(query)}`),
    ...
    deleteEvent: (eventId: string) => buildEndpoint(`events/${eventId}/delete/`), // debería cambiarse a number, y para eso hay que tocar la interfaz evento
  },
};
