...
urlpatterns = [
    ...
    path('api/v1/calendars/filter-by-label/<int:label_id>/', label_views.filter_calendars_by_label, name='filter_calendars_by_label'),
    ...
    path('api/v1/events/filter-by-label/<int:label_id>/', label_views.filter_events_by_label, name='filter_events_by_label'),
